  ...
  return (
    <div className={styles.login_container}>
      ...
      <div className={styles.welcome_text}>
        ...
        <p>
          {" "}
          Finding the perfect venue for your next event is just a few clicks
          away. Holidaze is your one-stop destination for discovering,
          comparing, and booking unique spaces that cater to all your special
          occasions.
        </p>
      </div>
    </div>
